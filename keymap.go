...
var keymap = []keyBinding{
	...
	{Keys: "m", Action: "matrix", Desc: "Open the scenario matrix: your config rendered across many widths and data conditions at once (overflow flagged)", Context: "main", Footer: true},

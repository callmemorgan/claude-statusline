# @morgan.rebrand/claude-statusline-win32-x64

Prebuilt [claude-statusline](https://github.com/callmemorgan/claude-statusline) binary for **Windows on x64** (win32/x64).
...
```bash
npm i -g @morgan.rebrand/claude-statusline-win32-x64
```

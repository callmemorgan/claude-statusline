# @morgan.rebrand/claude-statusline-linux-arm64

Prebuilt [claude-statusline](https://github.com/callmemorgan/claude-statusline) binary for **Linux on ARM64** (linux/arm64).
...
```bash
npm i -g @morgan.rebrand/claude-statusline-linux-arm64
```

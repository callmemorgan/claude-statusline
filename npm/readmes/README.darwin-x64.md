# @morgan.rebrand/claude-statusline-darwin-x64

Prebuilt [claude-statusline](https://github.com/callmemorgan/claude-statusline) binary for **macOS on Intel** (darwin/x64).
...
```bash
npm i -g @morgan.rebrand/claude-statusline-darwin-x64
```

# @morgan.rebrand/claude-statusline-linux-x64

Prebuilt [claude-statusline](https://github.com/callmemorgan/claude-statusline) binary for **Linux on x86-64** (linux/x64).
...
```bash
npm i -g @morgan.rebrand/claude-statusline-linux-x64
```

...
var LayoutPresets = []LayoutPreset{
	...
	},
	{
		...
		Segments: []string{
			"directory", "cost", "cost-rate", "tokens",
			"rate-limit-5h", "rate-limit-7d", "rate-limit-fable", "rate-limit-sonnet", "rate-limit-opus",
		},
		Lines: map[string]int{
			"cost": 1, "cost-rate": 1, "tokens": 1,
			"rate-limit-5h": 2, "rate-limit-7d": 2,
			"rate-limit-fable": 2, "rate-limit-sonnet": 2, "rate-limit-opus": 2,
		},
		Settings: map[string]map[string]any{
			"rate-limit-5h":     {"bar_width": 30},
			"rate-limit-7d":     {"bar_width": 30},
			"rate-limit-fable":  {"bar_width": 30},
			"rate-limit-sonnet": {"bar_width": 30},
			"rate-limit-opus":   {"bar_width": 30},
		},
		Theme: "gruvbox-dark",
	},
	{
	...
	{
		ID:   "quota-watch",
		Desc: "Wide smooth bars for context and plan/model rate limits",
		Segments: []string{
			"model", "context-window",
			"rate-limit-5h", "rate-limit-7d", "rate-limit-fable", "rate-limit-sonnet", "rate-limit-opus",
		},
		Lines: map[string]int{
			"model": 1, "context-window": 1,
			"rate-limit-5h": 2, "rate-limit-7d": 2,
			"rate-limit-fable": 2, "rate-limit-sonnet": 2, "rate-limit-opus": 2,
		},
		Settings: map[string]map[string]any{
			...
			"rate-limit-fable":  {"bar_width": 30, "iconset": "smooth"},
			"rate-limit-sonnet": {"bar_width": 30, "iconset": "smooth"},
			"rate-limit-opus":   {"bar_width": 30, "iconset": "smooth"},
		},
		Theme: "tokyo-night",
	},
	{
		...
		Segments: []string{
			...
			"rate-limit-fable", "rate-limit-sonnet", "rate-limit-opus",
		},
		...
		Settings: map[string]map[string]any{
			...
			"rate-limit-fable":  {"iconset": "blocks"},
			"rate-limit-sonnet": {"iconset": "blocks"},
			"rate-limit-opus":   {"iconset": "blocks"},
		},
